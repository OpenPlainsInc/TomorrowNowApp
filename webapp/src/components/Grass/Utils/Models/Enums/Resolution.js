 ...
 * @param {String} name Method name of how how the import resolution is determined.
 */
 export class Resolution {
    static estimated = new Resolution('estimated');
    static value = new Resolution('value');
    static region = new Resolution('region');
