...
r.null map='protected_areas_cog' null=0
r.mapcalc expression="urban_2001 = if(nlcd_2001_cog >= 21 && nlcd_2001_cog <= 24, 1, if(nlcd_2001_cog == 11 || nlcd_2001_cog >= 90 || protected_areas_cog, null(), 0))"
r.mapcalc expression="urban_2004 = if(nlcd_2004_cog >= 21 && nlcd_2004_cog <= 24, 1, if(nlcd_2004_cog == 11 || nlcd_2004_cog >= 90 || protected_areas_cog, null(), 0))"
r.mapcalc expression="urban_2006 = if(nlcd_2006_cog >= 21 && nlcd_2006_cog <= 24, 1, if(nlcd_2006_cog == 11 || nlcd_2006_cog >= 90 || protected_areas_cog, null(), 0))"
r.mapcalc expression="urban_2008 = if(nlcd_2008_cog >= 21 && nlcd_2008_cog <= 24, 1, if(nlcd_2008_cog == 11 || nlcd_2008_cog >= 90 || protected_areas_cog, null(), 0))"
r.mapcalc expression="urban_2011 = if(nlcd_2011_cog >= 21 && nlcd_2011_cog <= 24, 1, if(nlcd_2011_cog == 11 || nlcd_2011_cog >= 90 || protected_areas_cog, null(), 0))"
r.mapcalc expression="urban_2013 = if(nlcd_2013_cog >= 21 && nlcd_2013_cog <= 24, 1, if(nlcd_2013_cog == 11 || nlcd_2013_cog >= 90 || protected_areas_cog, null(), 0))"
r.mapcalc expression="urban_2016 = if(nlcd_2016_cog >= 20 && nlcd_2016_cog <= 24, 1, if(nlcd_2016_cog == 11 || nlcd_2016_cog >= 90 || protected_areas_cog, null(), 0))"
r.mapcalc expression="urban_2019 = if(nlcd_2019_cog >= 20 && nlcd_2019_cog <= 24, 1, if(nlcd_2019_cog == 11 || nlcd_2019_cog >= 90 || protected_areas_cog, null(), 0))"
...
# Sampling
r.mapcalc expression="urban_change_01_19 = if(urban_2019_nonull == 1, if(urban_2001_nonull == 0, 1, null()), 0)"
...
r.futures.potential input='sampling' output='$file::potential.csv' columns='devpressure_30_05_01_2001,forest_2001_smooth_perc,dist_to_water_km,dist_to_road_km' developed_column='urban_change_clip' subregions_column='counties' nprocs="7"
...
r.futures.calib development_start='urban_2001' development_end='urban_2019' subregions='counties' patch_sizes='$file::patches.csv' patch_threshold=1800 nprocs=7 -ls
