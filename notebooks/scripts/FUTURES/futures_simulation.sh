...
r.futures.pga subregions='counties' developed='urban_2016' predictors='road_dens_perc,forest_2001_smooth_perc,dist_to_water_km,slope,dist_to_interchanges_km' devpot_params='potential.csv' development_pressure='devpressure_30_05_01_2016' n_dev_neighbourhood=30 development_pressure_approach='gravity' gamma=0.5 scaling_factor=0.1 demand='demand.csv' discount_factor='0.10' compactness_mean='0.00' compactness_range='0.100.10,0.00,0.10,0.96,0.29,0.63' patch_sizes='patches.csv' num_neighbors=4 seed_search='probability' random_seed=1 output='final' output_series='step'
